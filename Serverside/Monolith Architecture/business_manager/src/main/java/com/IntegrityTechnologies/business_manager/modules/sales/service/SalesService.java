package com.IntegrityTechnologies.business_manager.modules.sales.service;
...
import com.IntegrityTechnologies.business_manager.modules.sales.repository.PaymentRepository;
import com.IntegrityTechnologies.business_manager.modules.sales.repository.SaleRepository;
...
public class SalesService {
    ...
    public SaleResponse createSale(SaleRequest req) {
        ...
        // create payments
        List<PaymentRecord> payments = Optional.ofNullable(req.getPayments()).orElse(Collections.emptyList())
                .stream()
                .map(pd -> {
                    PaymentRecord r = PaymentRecord.builder()
                            .id(UUID.randomUUID())
