...
//                Annotation tenantUser =
//                        AnnotatedElementUtils.findMergedAnnotation(method, TenantUserOnly.class);
//
//                Annotation tenantSupervisor =
//                        AnnotatedElementUtils.findMergedAnnotation(method, TenantSupervisorOnly.class);
//
//                Annotation tenantManager =
//                        AnnotatedElementUtils.findMergedAnnotation(method, TenantManagerOnly.class);
//
//                Annotation tenantAdmin =
//                        AnnotatedElementUtils.findMergedAnnotation(method, TenantAdminOnly.class);
//
//                Annotation platformAdmin =
//                        AnnotatedElementUtils.findMergedAnnotation(method, PlatformAdminOnly.class);
//
...
//                        ensureRoleGrant(permission, roles.get("SUPERUSER"));
//
//                    } else if (tenantAdmin != null) {
//
//                        ensureRoleGrant(permission, roles.get("ADMIN"));
//                        ensureRoleGrant(permission, roles.get("SUPERUSER"));
//
//                    } else if (tenantManager != null) {
//
//                        ensureRoleGrant(permission, roles.get("MANAGER"));
//                        ensureRoleGrant(permission, roles.get("ADMIN"));
//                        ensureRoleGrant(permission, roles.get("SUPERUSER"));
//
//                    } else if (tenantSupervisor != null) {
//
//                        ensureRoleGrant(permission, roles.get("SUPERVISOR"));
//                        ensureRoleGrant(permission, roles.get("MANAGER"));
//                        ensureRoleGrant(permission, roles.get("ADMIN"));
//                        ensureRoleGrant(permission, roles.get("SUPERUSER"));
//
...
//
//                        ensureRoleGrant(permission, roles.get("EMPLOYEE"));
//                        ensureRoleGrant(permission, roles.get("SUPERVISOR"));
//                        ensureRoleGrant(permission, roles.get("MANAGER"));
//                        ensureRoleGrant(permission, roles.get("ADMIN"));
//                        ensureRoleGrant(permission, roles.get("SUPERUSER"));
